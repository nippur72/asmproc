...
const grammar = require("./const");

interface NodeLine { type: "line"  };
interface NodeConst { type: "const", id: Node, expr: Node  };
interface NodeExpression { type: "expr", arg: Node  };

type Node = NodeLine | NodeConst | NodeExpression;
